    ...
    public static async Task SeedAsync(KartlyDbContext context, CancellationToken ct = default)
    {
        ...
        var products = new[]
        {
            new Product
            {
                ...
                Sku = "APL-IP15P-256",
                Category = ProductCategories.Smartphones,
                ImageUrl = "/api/media/seed/apple-iphone-15-pro-256gb.jpg",
                Brand = "Apple",
                Model = "iPhone 15 Pro",
            ...
            new Product
            {
                ...
                Sku = "SAM-GS24U-512",
                Category = ProductCategories.Smartphones,
                ImageUrl = "/api/media/seed/samsung-galaxy-s24-ultra-512gb.jpg",
                Brand = "Samsung",
            ...
            new Product
            {
                ...
                ImageUrl = "/api/media/seed/dell-xps-13-plus-laptop.jpg",
                Brand = "Dell",
            ...
            new Product
            {
                ...
                ImageUrl = "/api/media/seed/sony-wh-1000xm5-headphones.jpg",
                Brand = "Sony",
                Model = "WH-1000XM5",
            ...
            new Product
            {
                ...
                ImageUrl = "/api/media/seed/logitech-mx-master-3s-mouse.jpg",
                Brand = "Logitech",
                Model = "MX Master 3S",
            ...
            new Product
            {
                ...
                Sku = "LG-UG27-165",
                Category = ProductCategories.Monitors,
                ImageUrl = "/api/media/seed/lg-ultragear-27-gaming-monitor.jpg",
                Brand = "LG",
                Model = "27GP850",
            ...
            new Product
            {
                ...
                Sku = "ANK-737-24K",
                Category = ProductCategories.Accessories,
                ImageUrl = "/api/media/seed/anker-737-power-bank-24000mah.jpg",
                Brand = "Anker",
                Model = "737 PowerCore",
